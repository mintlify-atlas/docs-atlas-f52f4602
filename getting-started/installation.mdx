---
title: "Get Started with Retro Cosmic Arcade"
sidebarTitle: "Installation"
description: "Clone Retro Cosmic Arcade, install dependencies with npm/yarn/pnpm, start the Vite dev server, and open the site locally in minutes."
---
